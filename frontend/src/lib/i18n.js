  ...
  en: {
    translation: {
      ...
      examCreate: {
        ...
        sectionMeta: "Set the course, timing, and delivery policy before adding questions.",
        editMode: "Edit mode",
        draftSetup: "Draft setup",
        basicsTitle: "Assessment basics",
        basicsText: "Keep the exam identity clear for staff and students.",
        offeringHint: "This connects the draft to the correct term, course, and section.",
        autoData: "Auto-filled academic data",
        selectCourseTitle: "Select a course to generate the assessment title",
        systemFilled: "System-filled",
        assessmentCategory: "Assessment category",
        officialPeriod: "Official exam period",
        academicYear: "Academic year",
        semester: "Semester",
        cohort: "Generation / cohort",
        fromOffering: "From course offering",
        maximumPoints: "Maximum exam points",
        startsAt: "Starts at",
        endsAt: "Ends at",
        publishEditTitle: "Published exams return to draft after editing",
        publishEditText: "After saving changes, review the exam and publish it again so students use the updated settings.",
        publishDraftTitle: "Draft and publish workflow",
        publishDraftText: "Save the exam draft first, attach questions in the builder, then publish it for eligible students.",
      ...
      studentResults: {
        ...
        userRequired: "You must be signed in.",
        loadError: "Failed to load your exam results.",
        ...
        pending: "Pending",
        average: "Average",
        visibilityTitle: "Result visibility rule",
        visibilityText: "Scores stay hidden until staff complete review and publish the result.",
        noPublication: "No publication yet",
        latestPublished: "Latest published result",
        publishedResults: "Published results",
        pendingReview: "Pending review",
        showing: "Showing {{start}}-{{end}} of {{count}} result{{suffix}}.",
        resultView: "Result view",
        publishedCount: "{{count}} published",
        pendingCount: "{{count}} pending",
        rows: "{{count}} rows",
        rowsAria: "Results per page",
        loadingRecords: "Loading results...",
        emptyPublishedTitle: "No published results yet.",
        emptyPublishedText: "After grading and publication, your score and review notes will appear here.",
        emptyPendingTitle: "No pending attempts.",
        emptyPendingText: "Submitted attempts waiting for review will appear here.",
      ...
      smuSource: {
        checking: "Checking SMU",
        active: "SMU source active",
        manual: "Manual fallback",
        synced: "Synced data",
        fallback: "Fallback mode",
        review: "Review SMU contract"
      },
      examDetails: {
  ...
  sq: {
    translation: {
      ...
      examCreate: {
        ...
        sectionMeta: "Vendos lenden, kohen dhe politikat e zhvillimit para se te shtosh pyetje.",
        editMode: "Modalitet ndryshimi",
        draftSetup: "Draft",
        basicsTitle: "Te dhenat baze te vleresimit",
        basicsText: "Mbaje identitetin e provimit te qarte per stafin dhe studentet.",
        offeringHint: "Kjo e lidh draftin me afatin, lenden dhe grupin e sakte.",
        autoData: "Te dhenat akademike automatike",
        selectCourseTitle: "Zgjidh lenden per te gjeneruar titullin e vleresimit",
        systemFilled: "Plotesuar nga sistemi",
        assessmentCategory: "Kategoria e vleresimit",
        officialPeriod: "Afati zyrtar i provimit",
        academicYear: "Viti akademik",
        semester: "Semestri",
        cohort: "Gjenerata / kohorta",
        fromOffering: "Nga ofrimi i lendes",
        maximumPoints: "Piket maksimale te provimit",
        startsAt: "Fillon me",
        endsAt: "Perfundon me",
        publishEditTitle: "Provimet e publikuara kthehen ne draft pas ndryshimit",
        publishEditText: "Pas ruajtjes se ndryshimeve, kontrollo provimin dhe publikoje perseri qe studentet te perdorin konfigurimin e ri.",
        publishDraftTitle: "Rrjedha draft dhe publikim",
        publishDraftText: "Ruaje fillimisht draftin, shto pyetjet ne builder dhe pastaj publikoje per studentet e lejuar.",
        savingChanges: "Duke u ruajtur ndryshimet...",
        saveChanges: "Ruaj ndryshimet",
        saveDraft: "Ruaj draftin",
        assessmentTypes: {
          Exam: "Provim",
          "Colloquium 1": "Kollokfium 1",
          "Colloquium 2": "Kollokfium 2",
          "Practice Assessment": "Vleresim praktik"
        },
        examPeriods: {
      ...
      studentResults: {
        loading: "Duke u ngarkuar rezultatet...",
        userRequired: "Duhet te jesh i kycur.",
        loadError: "Rezultatet e provimeve nuk u ngarkuan.",
        badge: "Rezultatet",
        title: "Rezultatet e mia",
        subtitle: "Piket e publikuara shfaqen ketu pas rishikimit nga stafi. Tentimet ne pritje mbeten te fshehura derisa profesori t'i publikoje.",
        availableExams: "Provimet e disponueshme",
        submitted: "Dorezuara",
        published: "Publikuara",
        pending: "Ne pritje",
        average: "Mesatarja",
        visibilityTitle: "Rregulli i shfaqjes se rezultateve",
        visibilityText: "Piket mbeten te fshehura derisa stafi ta perfundoje rishikimin dhe ta publikoje rezultatin.",
        noPublication: "Ende pa publikim",
        latestPublished: "Rezultati i fundit i publikuar",
        publishedResults: "Rezultate te publikuara",
        pendingReview: "Ne pritje te rishikimit",
        showing: "Duke shfaqur {{start}}-{{end}} nga {{count}} rezultat{{suffix}}.",
        resultView: "Pamja e rezultateve",
        publishedCount: "{{count}} te publikuara",
        pendingCount: "{{count}} ne pritje",
        rows: "{{count}} rreshta",
        rowsAria: "Rezultate per faqe",
        loadingRecords: "Duke u ngarkuar rezultatet...",
        emptyPublishedTitle: "Ende nuk ka rezultate te publikuara.",
        emptyPublishedText: "Pas notimit dhe publikimit, piket dhe shenimet do te shfaqen ketu.",
        emptyPendingTitle: "Nuk ka tentime ne pritje.",
        emptyPendingText: "Tentimet e dorezuara qe presin rishikim do te shfaqen ketu.",
        submittedAt: "Dorezuar {{date}}",
        previous: "Prapa",
        next: "Para",
        page: "Faqja {{page}} nga {{count}}",
        publishedResult: "Rezultat i publikuar",
        finalScore: "Piket finale",
        grade: "Nota",
        percentage: "Perqindja",
        autoScore: "Piket automatike",
        publishedAt: "Publikuar",
        notes: "Shenime",
        noNotes: "Nuk ka shenime.",
        ready: "Gati",
        pass: "Kaluar",
        fail: "Nuk ka kaluar"
      },
      smuSource: {
        checking: "Duke kontrolluar SMU",
        active: "Burimi SMU aktiv",
        manual: "Modalitet manual",
        synced: "Te dhena te sinkronizuara",
        fallback: "Modalitet fallback",
        review: "Kontrollo kontraten SMU"
      },
      examDetails: {
