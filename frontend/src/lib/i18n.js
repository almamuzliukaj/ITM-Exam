  ...
  en: {
    translation: {
      ...
      questionBank: {
        ...
        allTypes: "All types",
        topic: "Topic",
        topicPlaceholder: "Filter by topic or section",
        ...
        topicSection: "Question section",
        questionCount: "{{count}} questions",
        import: {
          open: "Import CSV",
          title: "Import questions",
          subtitle: "Upload a CSV file, review the validation preview, then add ready rows to this offering.",
          csv: "CSV",
          file: "CSV file",
          columns: "Columns: topic, difficulty, type, points, prompt, optionA, optionB, optionC, optionD, correctAnswer, modelAnswer.",
          ...
          emptyText: "Download the template or upload a CSV file to preview questions before importing.",
          fixRows: "Add a valid CSV file before importing.",
          previewIssue: "Some rows need attention before import.",
          parseError: "CSV file could not be read.",
          error: "Questions could not be imported.",
          success: "{{count}} questions imported successfully.",
          importing: "Importing...",
          import: "Import ready rows"
        },
        editor: {
          ...
          points: "Points",
          topicPlaceholder: "Example: Programming, Algebra, SQL Practice",
          options: "MCQ options",
  ...
  sq: {
    translation: {
      ...
      questionBank: {
        ...
        topic: "Tema",
        topicPlaceholder: "Filtro sipas teme ose seksioni",
        difficulty: "Veshtiresia",
        allDifficulties: "Te gjitha veshtiresite",
        difficulties: {
          easy: "Lehte",
          medium: "Mesatare",
          hard: "Veshtire"
        ...
        topicSection: "Seksioni i pyetjeve",
        questionCount: "{{count}} pyetje",
        import: {
          open: "Importo CSV",
          title: "Importo pyetje",
          subtitle: "Ngarko nje CSV, kontrollo parapamjen e validimit, pastaj shto rreshtat gati ne kete offering.",
          csv: "CSV",
          file: "CSV file",
          columns: "Kolonat: topic, difficulty, type, points, prompt, optionA, optionB, optionC, optionD, correctAnswer, modelAnswer.",
          template: "Shkarko template",
          ready: " gati",
          needsFix: " duan rregullim",
          row: "Rreshti",
          status: "Statusi",
          readyLabel: "Gati",
          emptyTitle: "Nuk eshte zgjedhur file.",
          emptyText: "Shkarko template-in ose ngarko nje CSV per te pare pyetjet para importit.",
          fixRows: "Shto nje CSV valid para importit.",
          previewIssue: "Disa rreshta kerkojne vemendje para importit.",
          parseError: "CSV file nuk mund te lexohet.",
          error: "Pyetjet nuk u importuan.",
          success: "{{count}} pyetje u importuan me sukses.",
          importing: "Duke importuar...",
          import: "Importo rreshtat gati"
        },
        editor: {
          ...
          points: "Pikët",
          topicPlaceholder: "Shembull: Programming, Algebra, SQL Practice",
